...
$config['DX_website_name'] = 'my blog';
$config['DX_webmaster_email'] = 'webmaster@msn.com.ua';
...
$config['DX_salt'] = 'Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos';
