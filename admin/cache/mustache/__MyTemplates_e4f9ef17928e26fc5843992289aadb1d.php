<?php
class __MyTemplates_e4f9ef17928e26fc5843992289aadb1d extends Mustache_Template
{
...
';
        // 'list' section
        $buffer .= $this->section7344d9d406eadf3dbd32f9bfc86f67ce($context, $indent, $context->find('list'));
        $buffer .= $indent . '                                </tbody>
';
        $buffer .= $indent . '                            </table>
';
...
';
    ...
    private function section7344d9d406eadf3dbd32f9bfc86f67ce(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
