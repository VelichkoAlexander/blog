<?php
class __MyTemplates_01e6dcb2b66b940c72dc150fa9bb4f85 extends Mustache_Template
{
...
';
        // 'list' section
        $buffer .= $this->section1a37b14954a3d620482d1cf8a77a189b($context, $indent, $context->find('list'));
        $buffer .= $indent . '                            </tbody>
';
        $buffer .= $indent . '                        </table>
';
...
';
    ...
    private function section1a37b14954a3d620482d1cf8a77a189b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
