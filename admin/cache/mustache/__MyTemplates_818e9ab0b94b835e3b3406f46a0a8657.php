<?php
class __MyTemplates_818e9ab0b94b835e3b3406f46a0a8657 extends Mustache_Template
{
...
';
        // 'list' section
        $buffer .= $this->sectionEd29141d853a8ee7af808887d837732b($context, $indent, $context->find('list'));
        $buffer .= $indent . '                                </tbody>
';
        $buffer .= $indent . '                            </table>
';
...
';
    ...
    private function sectionEd29141d853a8ee7af808887d837732b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger" data-id="{{id}}">Delete</a>
                                        </td>
                                    </tr>
                                ';
            $buffer .= $this->mustache
...
';
                $buffer .= $indent . '                                            <a class="btn btn-danger" data-id="';
                $value = $this->resolveValue($context->find('id'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '">Delete</a>
';
