<?php
class __MyTemplates_b3415427515a3c784c1eca7b5251aa4d extends Mustache_Template
{
...
';
        // 'post' section
        $buffer .= $this->section46cee7824211ed044aa86cd769f59a84($context, $indent, $context->find('post'));
        $buffer .= $indent . '                        </div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function section46cee7824211ed044aa86cd769f59a84(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                <form id="add_post" role="form" action="/admin/posts/update_post" method="post">
            ...
            foreach ($values as $value) {
                $context->push($value);
                $buffer .= $indent . '                                <form id="add_post" role="form" action="/admin/posts/update_post" method="post">
';
