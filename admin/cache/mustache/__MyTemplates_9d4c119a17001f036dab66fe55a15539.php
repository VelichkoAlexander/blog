<?php
class __MyTemplates_9d4c119a17001f036dab66fe55a15539 extends Mustache_Template
{
...
';
        // 'list' section
        $buffer .= $this->section8ce54ef66dcafe2ee2ff12fa52ccfdae($context, $indent, $context->find('list'));
        $buffer .= $indent . '                                </tbody>
';
        $buffer .= $indent . '                            </table>
';
...
';
    ...
    private function section8ce54ef66dcafe2ee2ff12fa52ccfdae(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger" href="/posts/del_post/{{id}}">Delete</a>
                                        </td>
                                    </tr>
                                ';
            $buffer .= $this->mustache
...
';
                $buffer .= $indent . '                                            <a class="btn btn-danger" href="/posts/del_post/';
                $value = $this->resolveValue($context->find('id'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '">Delete</a>
';
