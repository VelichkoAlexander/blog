<?php
class __MyTemplates_0d68291d9f71c421b25a637236132594 extends Mustache_Template
{
...
';
        // 'list' section
        $buffer .= $this->sectionE250ea5ac360d7f9556a1431b59be6d8($context, $indent, $context->find('list'));
        $buffer .= $indent . '                            </tbody>
';
        $buffer .= $indent . '                        </table>
';
...
';
    ...
    private function sectionE250ea5ac360d7f9556a1431b59be6d8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a data-id="{{id}}" href="/admin/posts/edit_post/{{id}}" class="btn btn-primary">Edit</a>
...
';
                ...
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '" href="/admin/posts/edit_post/';
                $value = $this->resolveValue($context->find('id'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
