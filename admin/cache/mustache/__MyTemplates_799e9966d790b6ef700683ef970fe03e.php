<?php
class __MyTemplates_799e9966d790b6ef700683ef970fe03e extends Mustache_Template
{
...
';
        // 'list' section
        $buffer .= $this->sectionF034c17306225cedb5314fa66083fa6b($context, $indent, $context->find('list'));
        $buffer .= $indent . '                                </tbody>
';
        $buffer .= $indent . '                            </table>
';
...
';
    ...
    private function section519c85541b44e31526195a25ca90721a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionF034c17306225cedb5314fa66083fa6b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'is_visible' section
                $buffer .= $this->section519c85541b44e31526195a25ca90721a($context, $indent, $context->find('is_visible'));
                $buffer .= $indent . '                                        </td>
';
