<?php
class __MyTemplates_d01796204124859d42c86636d35f50d8 extends Mustache_Template
{
...
';
        // 'post' section
        $buffer .= $this->section871f0d1cd5c3255ee164ac68b6dbe2c0($context, $indent, $context->find('post'));
        $buffer .= $indent . '                        </div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionAcc1d1d7b06bfe8d2fe77cb204b9b28f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section871f0d1cd5c3255ee164ac68b6dbe2c0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'is_visible' section
                $buffer .= $this->sectionAcc1d1d7b06bfe8d2fe77cb204b9b28f($context, $indent, $context->find('is_visible'));
