<?php
class __MyTemplates_746b3e42486acb6fe4b089764400ab86 extends Mustache_Template
{
...
';
        // 'list' section
        $buffer .= $this->section46c0e5cd1a19cecaffd42f2cf9bcb352($context, $indent, $context->find('list'));
        $buffer .= $indent . '                                </tbody>
';
        $buffer .= $indent . '                            </table>
';
...
';
    ...
    private function sectionEaf38b3495c601c8f3e014df3b27eb6e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                $context->push($value);
                $buffer .= $indent . '                                                ';
                $value = $this->resolveValue($context->find('on'), $context, $indent);
                $buffer .= $value;
                $buffer .= '
';
                $buffer .= $indent . '                                            ';
                $value = $this->resolveValue($context->find('else'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '
';
                $buffer .= $indent . '                                                 ';
                $value = $this->resolveValue($context->find('off'), $context, $indent);
                $buffer .= $value;
                $buffer .= '
';
                $context->pop();
    ...
    private function section46c0e5cd1a19cecaffd42f2cf9bcb352(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'is_visible' section
                $buffer .= $this->sectionEaf38b3495c601c8f3e014df3b27eb6e($context, $indent, $context->find('is_visible'));
                $buffer .= $indent . '                                        </td>
';
