<?php
class __MyTemplates_cffdb0d6efef34320febe5de729a440a extends Mustache_Template
{
...
';
        // 'list' section
        $buffer .= $this->section2ce3106bc554817c4c9bf61db557893b($context, $indent, $context->find('list'));
        $buffer .= $indent . '                                </tbody>
';
        $buffer .= $indent . '                            </table>
';
...
';
    ...
    private function section2ce3106bc554817c4c9bf61db557893b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
