<?php
class __MyTemplates_361306801470dbad81890066e0d5f953 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE58bbae5106e2abe6f7ac6facc51e291($context, $indent, $context->find('auth_message'));
        $buffer .= $indent . '</div>';
        return $buffer;
    }

    private function sectionE58bbae5106e2abe6f7ac6facc51e291(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
