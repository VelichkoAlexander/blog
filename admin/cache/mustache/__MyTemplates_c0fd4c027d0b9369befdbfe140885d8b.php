<?php
class __MyTemplates_c0fd4c027d0b9369befdbfe140885d8b extends Mustache_Template
{
...
';
        // 'post' section
        $buffer .= $this->section7d24f03d7fd3eec385d012f9272af283($context, $indent, $context->find('post'));
        $buffer .= $indent . '                        </div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function section7d24f03d7fd3eec385d012f9272af283(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
