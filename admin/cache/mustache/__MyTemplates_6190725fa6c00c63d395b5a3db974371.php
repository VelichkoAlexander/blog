<?php
class __MyTemplates_6190725fa6c00c63d395b5a3db974371 extends Mustache_Template
{
...
';
        // 'list' section
        $buffer .= $this->section06fc21b66e012ecba8bac97b208c8d72($context, $indent, $context->find('list'));
        $buffer .= $indent . '                                </tbody>
';
        $buffer .= $indent . '                            </table>
';
...
';
    ...
    private function section06fc21b66e012ecba8bac97b208c8d72(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
