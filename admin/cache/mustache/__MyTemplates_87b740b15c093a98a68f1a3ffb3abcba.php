<?php
class __MyTemplates_87b740b15c093a98a68f1a3ffb3abcba extends Mustache_Template
{
...
';
        // 'list' section
        $buffer .= $this->section92b38dddbb1ef89f344b773f5459af81($context, $indent, $context->find('list'));
        $buffer .= $indent . '                                </tbody>
';
        $buffer .= $indent . '                            </table>
';
...
';
    ...
    private function sectionC3f3e6eb5c222dcd9f1aca3fc3fbb24e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section92b38dddbb1ef89f344b773f5459af81(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'is_visible' section
                $buffer .= $this->sectionC3f3e6eb5c222dcd9f1aca3fc3fbb24e($context, $indent, $context->find('is_visible'));
