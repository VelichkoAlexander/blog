<?php
class __MyTemplates_6a61bb2d617c8e3b5a9f673e64b04868 extends Mustache_Template
{
...
';
        // 'post' section
        $buffer .= $this->section172cd01ebd6622e311adb6075ec1fc79($context, $indent, $context->find('post'));
        $buffer .= $indent . '                        </div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function section172cd01ebd6622e311adb6075ec1fc79(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
